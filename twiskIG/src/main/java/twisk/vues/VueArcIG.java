...
public class VueArcIG extends Pane implements Observateur{
    ...
    public VueArcIG(MondeIG monde, ArcIG arc){
        ...
        ligne.setStyle("-fx-border-color: #f90000; -fx-background-insets: 0 0 -1 0, 0, 1, 2; -fx-background-radius: 3px, 3px, 2px, 1px;");


        this.polyligne = new Polyline();
        setPolyligne(arc.getPDC1(),arc.getPDC2());

        this.getChildren().add(this.ligne);
        System.out.println("ajout de la ligne a l'affichage dans la classe VueArcIG");
    }

    public void setPolyligne(PointDeControleIG P1, PointDeControleIG P2){
        ...
        this.polyligne.setFill(Color.RED);
